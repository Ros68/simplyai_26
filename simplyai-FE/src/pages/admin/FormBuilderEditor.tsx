...
export const QUESTION_TYPE_REGISTRY = {
  ...
  matrixdynamic: {
    name: "matrixdynamic",
    properties: ["name", "title", "description", "isRequired", "columns", "rowCount", "addRowText", "removeRowText", "cellType"],
    defaultJSON: {
      type: "matrixdynamic",
      name: "question1",
      title: "Question",
      columns: [
        ...
        { name: "col3", title: "Column 3", cellType: "dropdown" }
      ],
      rowCount: 2,
      addRowText: "Add Row",
  ...
  if (!creatorRef.current) {
    creatorRef.current = new SurveyCreator({
      ...
      supportedQuestionTypes: [
        ...
        "matrixdropdown", "matrixdynamic", "multipletext", "signaturepad", "html", "image"
      ]
    });
